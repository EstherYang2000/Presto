...
SELECT
    ...
    hermes.deleted_at
FROM
    postgresql.data.ml_post_hermes AS hermes
LEFT JOIN postgresql.data.latest_instagram_post AS post 
on hermes.post_id = post.platform_post_id and hermes.post_time = post.post_time;
-- SELECT
--     post.platform_user_id,
--     post.platform_post_id,
--     post.content,
